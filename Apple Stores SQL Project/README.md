...
**Here is the project datasets**: [Get the Project Datasets](.Apple Stores SQL Project/apple_datasets.zip)
...
**Here is the project datasets**: [Get the Project Datasets](.Apple Stores SQL Project/apple_sql_queries.sql)
